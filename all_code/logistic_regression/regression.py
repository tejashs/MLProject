...
class Regression:
    ...
    def enter_reg(self, train_entries, test_entries, gamma_t, constant, gen_output):
        weights, bias, train_acc = self.get_trained_reg(gamma_t, constant, train_entries)
        if gen_output:
            print (" --------------------------------------------------")
    ...
    def get_trained_reg(self, rate, constant, all_examples):
        bias = 0.1
    ...
    def get_best_learning_rate(self, learning_rates, constants, train_file):
        ...
        for constant in constants:
            for gamma_t in learning_rates:
                ...
                acc = self.enter_reg(train_exs, test_exs, gamma_t, constant, False)
